    ...
    >
      <div className="flex w-full items-end justify-between">
        ...
        <div className="flex flex-col gap-2 items-start justify-center py-[75px]">
          <Logo size="small" />
          <p className="text-[16px] text-[#d4d4d4] leading-[1.4] mt-2">
            © 2026
          </p>
          <p className="text-[16px] text-[#fafafa] leading-normal">
            All rights reserved.
          </p>
        </div>
        ...
        <div className="flex gap-10 items-end justify-end pb-[75px]">
          <LinkButton
            href="/privacy"
            className="text-[32px] font-semibold text-[#fafafa] leading-[1.25] hover:text-(--primary-cyan)"
          >
            Privacy Policy
          </LinkButton>
          <LinkButton
