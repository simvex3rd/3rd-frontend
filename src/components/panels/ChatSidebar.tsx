...
export function ChatSidebar({
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col gap-[48px] h-full">
        ...
        {!isOpen && (
          <button
            className="flex items-center justify-center p-[7px] rounded-[8px] hover:bg-white/10 transition-colors shrink-0"
            aria-label="New Chat"
          >
            <LucideMessageSquarePlus
