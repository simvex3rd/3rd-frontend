...
import { MemoModal } from "@/components/panels/MemoModal";
    ...
    <div className="relative w-full max-[1919px]:h-[133.33vh] h-screen bg-neutral-900 overflow-hidden">
      ...
      <main className="absolute inset-x-0 top-[102px] bottom-0 px-[80px] py-[40px]">
        <div className="flex gap-[32px] h-full">
          ...
          <div className="flex-[45] grid grid-rows-3 gap-[20px] min-w-0">
            {/* Memo Card */}
            <section className="flex flex-col gap-[12px]">
              ...
              >
                <GradientBorder />
                <LucideSquarePen className="w-[32px] h-[32px] text-primary z-10" />
      ...
      {showMemo && (
        <MemoModal modelId={modelId} onClose={() => setShowMemo(false)} />
      )}
      {showQuiz && (
